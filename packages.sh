...
rm -rf ./theme/luci-theme-design luci-theme-atmaterial luci-theme-ifit luci-theme-opentopd luci-theme-neobird luci-theme-infinityfreedom
...
git clone https://github.com/sirpdboy/luci-theme-opentopd.git ./theme
git clone https://github.com/xiaoqingfengATGH/luci-theme-infinityfreedom.git theme/luci-theme-infinityfreedom
git clone https://github.com/thinktip/luci-theme-neobird.git ./theme
git clone https://github.com/sirpdboy/luci-theme-kucat.git ./theme
