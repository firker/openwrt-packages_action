#!/bin/bash
rm -rf adguardhome luci-app-adguardhome cpulimit luci-app-cpulimit luci-app-autotimeset luci-app-onliner smartdns luci-app-homeassistant luci-app-smartdns
